...
Label merupakan class yang dapat mengatur label-label yang akan tampil pada peta.

\subsection {Memberi Label}
    Untuk melengkapi informasi pada peta perlu diberikan berbagai macam keterangan-keterangan. Tambahan informasi tersebut
berupa atribut peta yang tersedia pada template seperti nama pembuat, tahun pembuatan, nama-nama tempat pada dan di sektar lokasi peta, dan lain-lain.
