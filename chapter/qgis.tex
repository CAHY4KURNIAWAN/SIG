...
Situs resmi QGIS akan terlihat seperti gambar \ref{image2}.
\begin{figure}[ht]
        \centerline{\includegraphics[width=0.5\textwidth]{figures/image2}}
        \caption{Tampilan Situs Qgis}
        \label{image2}
        \end{figure}
\item
Klik Unduh Sekarang
\item
Jika Anda menggunakan Windows, klik pada QGIS Standalone Installer Version 2.8 (32 bit). Nomor versi komputer Anda mungkin berbeda seperti diperlihatkan pada gambar \ref{image3}.
\begin{figure}[ht]
        \centerline{\includegraphics[width=0.25\textwidth]{figures/image3}}
        \caption{Pilihan Paket Aplikasi}
        \label{image3}
        \end{figure}
\item
Jika Anda tidak menggunakan Windows, pilih Sistem Operasi Anda dari menu yang tersedia pada gambar \ref{image4}. Ikuti intruksi instalasi.
\begin{figure}[ht]
        \centerline{\includegraphics[width=0.5\textwidth]{figures/image4}}
        \caption{Pilihan Sistem Operasi}
        \label{image4}
        \end{figure}
\item
...
\begin{figure}[ht]
        \centerline{\includegraphics[width=0.5\textwidth]{figures/image7}}
...
\begin{figure}[ht]
        \centerline{\includegraphics[width=0.5\textwidth]{figures/image8}}
        \caption{Lokasi Instalasi}
        \label{image8}
        \end{figure}
\item
Pada jendela berikutnya, klik Install tanpa mencentang apapun yang ada di dalam kotak pada gambar \ref{image9}.
\begin{figure}[ht]
        \centerline{\includegraphics[width=0.5\textwidth]{figures/image9}}
...
View
\begin{figure}[ht]
    \centerline{\includegraphics[width=0.5\textwidth]{figures/menubar2}}
...
Setting
\begin{figure}[ht]
    \centerline{\includegraphics[width=0.5\textwidth]{figures/menubar3}}
...
Plugin
\begin{figure}[ht]
    \centerline{\includegraphics[width=0.5\textwidth]{figures/menubar4}}
...
Vector
\begin{figure}[ht]
    \centerline{\includegraphics[width=0.5\textwidth]{figures/menubar5}}
