...
\begin{figure}[ht]
        ...
        \end{figure}
\item
Pada jendela berikutnya, klik Install tanpa mencentang apapun yang ada di dalam kotak.\ref{qgis:image9}.
\begin{figure}[ht]
...
QGIS akan memulai untuk menginstall. Ini mungkin akan membutuhkan beberapa waktu untuk selesai.\ref{qgis:image10}.
\begin{figure}[ht]
        ...
        \end{figure}
\item
Klik Finish untuk melengkapi instalasi. Kemudian komputer Anda akan me-reboot secara otomatis.\ref{qgis:image11}.
\begin{figure}[ht]
        ...
        \end{figure}
\item
Buka QGIS dari Start Menu, berikut tampilan QGIS.\ref{qgis:image12}.
\begin{figure}[ht]
