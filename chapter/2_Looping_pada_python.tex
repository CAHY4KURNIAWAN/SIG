...
\subsubsection{Contoh penggunaan range nilai\_awal,nilai\_akhir,pencacah}
Berikut ini contoh penggunaan range untuk menampilkan bilangan dari 1 – 100 dengan penambahan/pencacah 1 dengan menambahkan \verb|end=’ ’| agar bilangan tampil secara horizontal tidak pindah baris ke bawah
\begin{verbatim}
