...
Perangkat lunak menyediakan penerjemah data form-to-coverage, dan ARC / INFO juga menyediakan penerjemah coverage-to-shape. Untuk pertukaran dengan format data lainnya, shapefile 
...
Shapefile adalah format data vektor geospatial untuk software GIS yang dikembangkan oleh ESRI (Environmental System Research Institute)
