...
Shapefiles awalnya dikembangkan oleh Environmental Systems Research Institute (ESRI, 1998)\ref{esri}
	...
	\caption{ESRI.}
	\label{esri}
	\end{figure}dan merupakan format data geospasial untuk perangkat lunak sistem informasi geografis , seperti ESRI ArcGIS dan Quantum GIS.
...
\item Ship : koordinat/titik
\item      Dbf : tabel/database
\item   Shx : index data
