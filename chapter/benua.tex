...
perpotongan belahan utara-selatan bumi (garis Khatulistiwa) dengan garis yang membelah bumi timur- barat\cite{zuhdi2012sistem}.
...
\section{Geometri Koordinat}
 Pembelajaran sub tajuk - sub tajuk Geometri Koordinat, yaitu jarak antara dua titik, pembagian tembereng garis, luas poligon, persamaan garis lurus, garis lurus selari dan garis lurus serenjang, persamaan lokus yang melibatkan jarak antara dua titik dan menentukan hubungan antara pencapaian responden dalam topik pelajaran\cite{shong2013analisis}.
