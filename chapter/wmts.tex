...
\begin{enumerate}
	\item Membangun alamat pengenal sumber daya seragam (URL) dari gambar ubin yang tumpang tindih pada titik waktu tertentu. 
	\item Mendownload gambar ubin. 
	\item Temukan koordinat piksel yang sesuai dengan titik kepentingan di dalam gambar yang di download.
	\item Ubah warna piksel atau indeks warna piksel ke unit variabel yang teramati.
\end{enumerate}
