...
Raster yang mewakili data tematik dapat diturunkan dari analisis data lainnya. Aplikasi analisis yang umum adalah mengklasifikasikan citra satelit dengan kategori tutupan lahan. Pada dasarnya, kegiatan ini mengelompokkan nilai data multispektral ke dalam kelas (seperti tipe vegetasi) dan memberikan nilai kategoris. Peta tematik juga dapat dihasilkan dari operasi geoprocessing yang menggabungkan data dari berbagai sumber, seperti vektor, raster, dan data medan. Misalnya, Anda dapat mengolah data melalui model geoprocessing untuk membuat dataset raster yang memetakan kesesuaian untuk aktivitas tertentu. Berikut adalah contoh dataset raster yang diklasifikasikan yang menunjukkan penggunaan lahan.

Raster sebagai atribut fitur

Raster yang digunakan sebagai atribut fitur dapat berupa foto digital, dokumen pindaian, atau gambar hasil pindaian yang terkait dengan objek atau lokasi geografis. Lapisan paket mungkin telah memindai dokumen legal yang mengidentifikasi transaksi terakhir untuk paket tersebut, atau lapisan yang menunjukkan bukaan gua mungkin memiliki gambar bukaan gua yang sebenarnya terkait dengan fitur titik. Berikut adalah gambar digital dari pohon tua yang besar yang dapat digunakan sebagai atribut pada lapisan lanskap yang mungkin dipelihara kota.
