...
\begin{figure}[ht]
    \centerline{\includegraphics[width=1\textwidth]{figures/contoh bangun.png}}
...
\begin{figure}[ht]
    \centering
\includegraphics[width=0.25\textwidth]{figures/sisi lengkung.png}
...
\begin{figure}[ht]
    \centerline{\includegraphics[width=1\textwidth]{figures/unsur bola.png}}
...
\begin{figure}[ht]
    \centerline{\includegraphics[width=1\textwidth]{figures/bola tabung.png}}
